...
const Register = () => {
  ...
  const addOtherContact = () => {
    if (otherContact && otherContact.length === 10 && /^\d+$/.test(otherContact) && otherContacts.length < 5) {
      setOtherContacts([...otherContacts, otherContact]);
      setOtherContact("");
    } else {
                ...
                <div className="space-y-2">
                  <div className="flex space-x-2">
                    <Input
                      ...
                      type="tel"
                      disabled={isLoading || otherContacts.length >= 5}
                      value={otherContact}
